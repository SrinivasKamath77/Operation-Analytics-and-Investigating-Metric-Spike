...
task 2: Let’s say the above metric is called throughput. 
...
task 4: Let’s say you see some duplicate rows in the data. How will you display duplicates from the table?*/
